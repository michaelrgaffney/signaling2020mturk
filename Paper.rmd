...
Some evolutionary theorists have questioned the bargaining model based on evidence that depression is aversive to social partners [@nettle2004; @allen2006; @nesse2006; @myers2016]. These critics failed to recognize the central role of *conflict* in the signaling/bargaining models. Anger is aversive to targeted social partners, yet it is probably an adaptation that exploits advantages in physical or social formidability to force concessions from them [@SellEtAl2009]. Aversive responses to depressive bargaining are likewise expected throughout the process, with potential helpers signaling the costliness of providing support in turn. Importantly, as with anger, aversive responses to depression do not prevent concessions by interdependent social partners [@SymeHagen2021].
...
The primary aim of this study was to examine responses to emotional signals that varied from low to high cost, in an experimental vignette study in which a possible victim of adversity asks for help from the participant, but has incentives to exaggerate her need. In the bargaining framework, the willingness to delay credibly signals the valuation of current cooperative arrangements, with greater delays indicating lower valuations. As signal cost increased, we predicted that participants would report (1) increased belief in the signaler's claims and (2) increased likelihood of providing help, with (3) the increased likelihood of providing help mediated by the increased belief in the signaler's need. 
...
After rating their beliefs and actions, and which emotions they thought the potential victim was experiencing, participants were randomized into either the control condition or one of four emotional signals by the victim (in order of increasing signal cost): (1) control condition: a verbal request without additional signaling; (2) crying; (3) mild-depression; (4) depression; and (5) a suicide attempt. The signals involved the participant encountering the victim some time after the adverse event and observing, e.g., crying, sad expressions, or poor personal hygiene. These descriptions did not use the terms depression, depressed, suicidal, or mental health.
