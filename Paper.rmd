...
The prevailing view is that depression causes social rejection. The aim of this study was to test the hypothesis that when there are conflicts of interest, depressive and suicidal behaviors increase belief that victims of adversity are telling the truth and consequently increase willingness to help them.

<!-- Beneficial responses to depressed individuals have also been reported, such as increased caretaking [@HokansonEtAl1986], more offers of advice and support [@stephens1987], and reduced aggression within families [@hops1987; @dadds1992; @SheeberEtAl2001].  -->
