...
Individuals who have suffered a negative life event will often need help to mitigate the fitness cost. To obtain this help, they must signal need, e.g., by verbally requests, sad facial expressions, and crying. But if they have conflicts of interest with social partners who could provide that help, and if their need is private information, their signals might not be believed if the signals, like crying, could easily be faked [@Zahavi1975; @mokkonen2016] and if the cost of believing a deceptive signal was high [@dawkins1978; @johnstone1993; @Hasson1994].


demonstrating that one's need is genuine has likely been a recurrent adaptive problem since humans evolved the capacity to provide instrumental support to one another.
