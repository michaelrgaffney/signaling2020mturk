...
Some evolutionary theorists have questioned the bargaining model based on evidence that depression is aversive to social partners [@nettle2004; @allen2006; @nesse2006; @myers2016]. These critics fail to acknowledge the central role of *conflict* in the signaling/bargaining models. Anger causes negative reactions in targeted social partners, yet it is probably an adaptation that exploits advantages in physical or social formidability to force concessions from others [@SellEtAl2009]. Aversive responses to bargaining are expected throughout the process, with potential helpers likely signaling the costliness of providing support in turn. Importantly, such responses do not prevent the delivery of meaningful benefits [@SymeHagen2021].
...
The main limitation of this study is that is has less ecological validity than real-world observations of depressed individuals interacting with their social partners. This may have biased results in a pro-signaler direction if the lack of real costs of helping made support feel less costly or if there was a social desirability bias toward helping [@grimm2010]. It may have also biased participants against helping if they could not fully imagine the characters in the story as kin or important cooperative partners, and the survey's short duration may have weakened the strength of the costlier signals as bargaining tools.
