...
The final part of the survey was a brief demographic questionnaire which asked for (1) the age, (2) sex, (3) number of siblings, (4) number of sons, (5) number of daughters, (6) current relationship status, (7) highest level of education, and (8) the annual household income of each participant.
...
Another limitation is that our control included a signal in the form of a verbal request, preventing comparisons to non-signaling strategies. Similarly, our design did not include vignettes with male signalers. For this reason, we have no data on the possibility of sex differences in the effectiveness of the signaling strategies examined.

In terms of data quality our largest limitation is that, compared to the US sample, far more Indian participants were filtered out by our attention checks, something which could be consistent with botting, unfamiliarity with English, or low effort responses [@kennedy2020]. Assuming this corresponded with lower-quality responses among those who passed the attention checks, the weak signal effect in the thwarted marriage vignette may simply be due to added noise rather than differences in the scenario or the effectiveness of the signals compared to those in the US.
