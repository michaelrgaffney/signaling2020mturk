...
```{r feedbackplot, fig.width=9, fig.cap="The distribution of optional feedback provided at the end of the study. None: no feedback provided (includes, e.g., 'none', 'no', 'N/A'). Generic: A few short words, such as 'nice study', or 'thanks'. Attention check: question or comment on the attention checks. Informative: one or two sentences commenting on specific aspects of the survey."}
plot_feedback
```
