...
The primary aim of this study was to examine responses to various forms of emotional signaling in an experimental vignette study. As signal cost increases, and signals therefore become less profitable to fake, we predicted that participants would report (1) increased belief in the signaler's claims and (2) increased likelihood of providing help, with (3) the increased likelihood of providing help mediated by the increased belief in the signaler's need. A secondary aim was to investigate a scenario that is common in traditional societies but uncommon in Western societies -- arranged marriages -- where conflicts between parents and offspring often result in depression and suicidality [@SymeEtAl2016]
...
Participants for this study were recruited from Amazon Mechanical Turk, a crowdsourcing platform that allows for the creation of Human Intelligence Tasks (HITs) that workers can complete for pay. As Amazon provides the infrastructure, it allows for a relatively low-cost way of collecting data for academic research at the cost of the data not being representative of any real population [@thomas2017]. Despite this limitation, it is more diverse than most convenience samples [@kennedy2020; @DworkinEtAl2016; @thomas2017], with turkers in the US mainly differing in being younger, more educated, and lower income than the greater U.S. population [@RossEtAl2010; @boas2020]. 

To test emotional signals in an arranged marriage vignette, we recruited an Indian MTurk sample. Indian samples are also likely to be younger and more educated than the general population but differ from US samples in that they are less diverse, have higher incomes relative to other Indians, and are more likely to come from regions with good internet access [@boas2020].
...
All participants provided informed consent, and the consent form warned that some content might involve sexual assault. We estimated the study would take 4-8 minutes to complete for participants who did not take breaks. All participants who passed the attention checks were paid \$1 for their time, for an estimated rate of \$7.50/hr to \$15/hr (75% of US participants completed in `r signif(quantile(d_US$TotalTime, 0.75)/60, 2)` minutes; 75% of Indian participants completed in `r signif(quantile(d_India$TotalTime, 0.75)/60, 2)` minutes). This study was certified exempt by the Washington State University Human Research Protection Program.

## Vignettes

Four vignettes were used in this study that involved (1) claims of severe adversity that were private information, (2) conflicts of interest that would undermine believability of these claims, and (3) emotional signals. The vignette scenarios involved potentially severe types of adversity, such as sexual and non-sexual assault and thwarted marriage, that often precede cases of depression and suicidality in the ethnographic and clinical record.

### Time 1: Claim of need in a conflictual relationship

Participants in the US sample were randomly assigned to either the "basketball coach," "romantic partner," or "brother-in-law" vignettes. In the "basketball coach" scenario, the star player on a university basketball team comes to the participant, who is asked to imagine themselves as the athletic director at a university, and claims she was sexually assaulted by her head coach, a physically powerful man. However, there has been a history of conflict between the star player and the coach over playing time, and police are unable to find evidence that corroborate her claims.

The "brother-in-law" vignette involved participants imagining that they let their sister, brother-in-law, and niece move in with the participant and their 15-year-old daughter after their sister's family lost their house in a fire. During this time, the participant's daughter becomes jealous of her cousin, who appears to be a social competitor. A few weeks after claiming her cousin was trying to still her boyfriend, she then accuses her uncle of sexually assaulting her.

The "romantic partner" vignette had participants imagine that they found a highly desirable partner after years of being single. However, their 13-year-old daughter, who has a history of trying to get in the way of their relationships, is clearly not happy with this. After a period of sustained conflict with both the participants and the romantic partner, she accuses the romantic partner of physically assaulting her but cannot produce any evidence.
